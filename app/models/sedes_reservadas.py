...
class SedesReservadas(db.Model):
    ...
    def __init__(self, fecha_entrega_sedes,marco_material,marco_cantidad,patillas_material,patillas_cantidad,estuche_material,escuche_cantidad,lentes_material,lentes_cantidad):
